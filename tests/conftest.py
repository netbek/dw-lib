...
PEERDB_TEST_ENV = {
    ...
    "PEERDB_FLOW_API_IMAGE": "ghcr.io/peerdb-io/flow-api:stable-v0.36.21",
    "PEERDB_FLOW_SNAPSHOT_WORKER_IMAGE": "ghcr.io/peerdb-io/flow-snapshot-worker:stable-v0.36.21",
    "PEERDB_FLOW_WORKER_IMAGE": "ghcr.io/peerdb-io/flow-worker:stable-v0.36.21",
    "PEERDB_SERVER_IMAGE": "ghcr.io/peerdb-io/peerdb-server:stable-v0.36.21",
    "PEERDB_UI_IMAGE": "ghcr.io/peerdb-io/peerdb-ui:stable-v0.36.21",
    "POSTGRES_IMAGE": "postgres:18.3-alpine3.23",
    "TEMPORAL_ADMIN_TOOLS_IMAGE": "temporalio/admin-tools:1.29.6.1-tctl-1.18.4-cli-1.7.0",
