...
class TestLoadConfig(DatabaseTest):
    ...
    def test_valid_config(self, pytestconfig, all_postgres_tables: list[Table]):
        ...
        config_path = os.path.join(
            pytestconfig.rootpath, "tests/peerdb/fixtures/peerdb.clickhouse.yaml"
        )
...
class TestIntegration(PeerDBTest):
    ...
    def peerdb_config_path(self, pytestconfig) -> Generator[str, Any, None]:
        yield os.path.join(pytestconfig.rootpath, "tests/peerdb/fixtures/peerdb.clickhouse.yaml")
